...
function createServerCert {
    ...
    rm $TARGETDIR/server.csr $TARGETDIR/extfile.cnf  && cp -r $TARGETDIR/ca.pem $TARGETDIR/ca-cert.pem
    #rm $TARGETDIR/server.csr $TARGETDIR/extfile.cnf $TARGETDIR/ca.srl && cp -r $TARGETDIR/ca.pem $TARGETDIR/ca-cert.pem
...
function createClientCert {
    ...
    rm $TARGETDIR/client.csr $TARGETDIR/extfile.cnf $TARGETDIR/ca.srl  && cp -r $TARGETDIR/ca.pem $TARGETDIR/ca-cert.pem
